          ...
          <Card className="card-glow">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                To start a return request, email us at hello@makebelieveimprints.com with your order number and photos of the issue. We'll get back to you within 24 hours.
              </p>
            </CardContent>
          </Card>
